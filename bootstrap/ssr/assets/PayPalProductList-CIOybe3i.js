...
function PayPalProductList({ pp_products }) {
  var _a;
  ...
  return /* @__PURE__ */ jsxs(Card, { children: [
    ...
    /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(Deferred, { data: "pp_products", fallback: /* @__PURE__ */ jsx("div", { children: "Loading products..." }), children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
      !(pp_products == null ? void 0 : pp_products.products) && /* @__PURE__ */ jsx(Label, { className: "text-red-500", children: "No products found." }),
      (_a = pp_products == null ? void 0 : pp_products.products) == null ? void 0 : _a.map((product, idx) => /* @__PURE__ */ jsxs(Collapsible, { className: "p-2 border rounded-md bg-zinc-900", children: [
        /* @__PURE__ */ jsxs(CollapsibleTrigger, { className: "flex flex-row justify-between w-full items-center", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 items-start", children: [
            /* @__PURE__ */ jsxs(Label, { children: [
              "ID: ",
              /* @__PURE__ */ jsx("span", { className: "text-indigo-300", children: product == null ? void 0 : product.id })
            ] }),
            /* @__PURE__ */ jsxs(Label, { children: [
              "NAME: ",
              /* @__PURE__ */ jsx("span", { className: "text-indigo-300", children: product == null ? void 0 : product.name })
            ] })
          ] }),
