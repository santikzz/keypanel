...
function CreateResellerDialog() {
  ...
  const reachedLimit = (user == null ? void 0 : user.resellers_count) >= (user == null ? void 0 : user.subscription.max_resellers);
    ...
    /* @__PURE__ */ jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxs(
      Button,
      {
        ...
        children: [
          ...
          "New reseller",
          " (",
          user == null ? void 0 : user.resellers_count,
          "/",
          user == null ? void 0 : user.subscription.max_resellers,
          ")"
        ]
      }
    ) }),
