...
function PayPalPlanList({ pp_plans }) {
  var _a;
  ...
  return /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(Label, { className: "text-xl", children: "PayPal Plans" }) }),
    /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(Deferred, { data: "pp_plans", fallback: /* @__PURE__ */ jsx("div", { children: "Loading plans..." }), children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
      !(pp_plans == null ? void 0 : pp_plans.plans) && /* @__PURE__ */ jsx(Label, { className: "text-red-500", children: "No plans found." }),
      (_a = pp_plans == null ? void 0 : pp_plans.plans) == null ? void 0 : _a.map((plan, idx) => /* @__PURE__ */ jsxs(Collapsible, { className: "p-2 border rounded-md bg-zinc-900", children: [
