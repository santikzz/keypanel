...
function Login({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: `login min-h-screen items-center justify-center flex flex-col gap-6 bg-zinc-900/25`, children: [
      "  ",
      /* @__PURE__ */ jsx(Card, { className: "overflow-hidden w-[50em] shadow-lg", children: /* @__PURE__ */ jsxs(CardContent, { className: "grid p-0 md:grid-cols-2", children: [
