...
function IndexCreateLicenseDialog({ applications, timeOptions }) {
  ...
  const reachedLimit = (user == null ? void 0 : user.license_count) >= (user == null ? void 0 : user.subscription.max_keys);
  const keysLeft = (user == null ? void 0 : user.subscription.max_keys) - (user == null ? void 0 : user.license_count);
    ...
    /* @__PURE__ */ jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxs(
      Button,
      {
        ...
        children: [
          ...
          "/",
          user == null ? void 0 : user.subscription.max_keys,
          ")"
        ]
      }
    ) }),
