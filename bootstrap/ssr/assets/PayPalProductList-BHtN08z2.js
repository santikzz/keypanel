...
function PayPalProductList({ products }) {
  ...
  return /* @__PURE__ */ jsxs(Card, { children: [
    ...
    /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(Deferred, { data: "products", fallback: /* @__PURE__ */ jsx("div", { children: "Loading products..." }), children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
      !(products == null ? void 0 : products.products) && /* @__PURE__ */ jsx(Label, { className: "text-red-500", children: "No products found." }),
      (_a = products == null ? void 0 : products.products) == null ? void 0 : _a.map((product, idx) => /* @__PURE__ */ jsxs(Collapsible, { className: "p-2 border rounded-md bg-zinc-900", children: [
