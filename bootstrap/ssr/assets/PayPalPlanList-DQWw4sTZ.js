...
function PayPalPlanList({ plans }) {
  ...
  return /* @__PURE__ */ jsxs(Card, { children: [
    ...
    /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(Deferred, { data: "plans", fallback: /* @__PURE__ */ jsx("div", { children: "Loading plans..." }), children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
      !(plans == null ? void 0 : plans.plans) && /* @__PURE__ */ jsx(Label, { className: "text-red-500", children: "No plans found." }),
      (_a = plans == null ? void 0 : plans.plans) == null ? void 0 : _a.map((plan, idx) => /* @__PURE__ */ jsxs(Collapsible, { className: "p-2 border rounded-md bg-zinc-900", children: [
