...
function Subscribe({ checkout }) {
  ...
  return /* @__PURE__ */ jsx(Authenticated, { children: /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsx(Deferred, { data: "checkout", fallback: /* @__PURE__ */ jsx("div", { children: "Loading..." }), children: /* @__PURE__ */ jsx("x-paddle-button", { checkout, class: "px-8 py-4", children: "Subscribe" }) })
  ] }) });
}
export {
