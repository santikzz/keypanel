...
import { Plus, Calendar, Clock1, StickyNote, Layers, Loader2 } from "lucide-react";
...
function ShowCreateLicenseDialog({ application }) {
  ...
  const onSubmit = async (values) => {
    ...
    const _values = {
      ...values,
      app_id: application == null ? void 0 : application.id,
      is_bulk: isBulk
    };
    router.post(
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(Dialog, { open, onOpenChange: isOpen, children: [
