...
import { C as Card, b as CardContent } from "./card-H30tULAN.js";
...
function Login({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: `login min-h-screen items-center justify-center flex flex-col gap-6 bg-black`, children: [
      "  ",
      /* @__PURE__ */ jsx(Card, { className: "overflow-hidden w-[50em] shadow-2xl shadow-indigo-600/20 border-indigo-700/25", children: /* @__PURE__ */ jsxs(CardContent, { className: "grid p-0 md:grid-cols-2", children: [
        /* @__PURE__ */ jsx("form", { className: "p-6 md:p-8", onSubmit: submit, children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center text-center", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-balance text-muted-foreground", children: "Login to your KeyCore account" })
          ] }),
