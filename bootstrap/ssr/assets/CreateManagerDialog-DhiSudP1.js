...
function CreateManagerDialog() {
  ...
  const reachedLimit = (user == null ? void 0 : user.managers_count) >= (user == null ? void 0 : user.subscription.max_managers);
    ...
    /* @__PURE__ */ jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxs(
      Button,
      {
        ...
        children: [
          ...
          "New manager",
          " (",
          user == null ? void 0 : user.managers_count,
          "/",
          user == null ? void 0 : user.subscription.max_managers,
          ")"
        ]
      }
    ) }),
