...
import { CreateManagerDialog } from "@/Pages/Users/Fragments/CreateManagerDialog"

export function ManagersTable({ managers }: { managers: object[] }) {
    ...
    const columns: ColumnDef<object[]>[] = [
        ...
        },
        {
            ...
            cell: ({ row }) => <div>
                {row.getValue("disabled") == '1' ? "Yes" : "No"}
            </div>,
        },
        {
            id: "actions",
                        ...
                        <TableBody>
                            {table.getRowModel().rows?.length ? (
                                ...
                                <TableRow>
                                    ...
                                    >
                                        <Deferred data="managers" fallback={
