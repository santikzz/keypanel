...
import { LogIn, EyeIcon, EyeOffIcon, Loader2 } from 'lucide-react';
...
export default function Login({
    ...
    return (
        <>
            ...
            <div className={`login min-h-screen items-center justify-center flex flex-col gap-6 bg-black`}>  {/* style={{ backgroundImage: `url(/assets/waves.jpg)`, backgroundSize: 'fill' }} */}
                <Card className="overflow-hidden w-[50em] shadow-2xl shadow-indigo-600/20 border-indigo-700/25">
