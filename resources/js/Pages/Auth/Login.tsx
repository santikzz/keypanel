...
export default function Login({
    ...
    return (
        <>
            ...
            <div className={`login min-h-screen items-center justify-center flex flex-col gap-6 bg-zinc-900/25`}>  {/* style={{ backgroundImage: `url(/assets/waves.jpg)`, backgroundSize: 'fill' }} */}
                <Card className="overflow-hidden w-[50em] shadow-lg">
